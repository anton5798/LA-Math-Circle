...
\part{b} Show the converse: if $y + z = -b/a$, then $f(y) = f(z)$. If you completed both parts of the problem, congratulations -- you have successfully proven that a parabola (graph of a quadratic function) is symmetric with respect to the line $x = -b/a$.
\end{prb}
